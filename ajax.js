...
function validId(val) {
    if (val ==1){
        ...
        document.getElementById('id_card_no').setAttribute('placeholder',"SZ12345");
    }else if(val ==2){
        ...
        document.getElementById('id_card_no').setAttribute('type','text');
        document.getElementById('id_card_no').setAttribute('data-minlength','5');
        document.getElementById('id_card_no').setAttribute('placeholder',"1234567");
    }else if(val == 4){
        document.getElementById('id_card_no').setAttribute('type','text');
        document.getElementById('id_card_no').setAttribute('data-minlength','5');
        document.getElementById('id_card_no').setAttribute('placeholder',"RJ123456");
    }
}
